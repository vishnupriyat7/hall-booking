    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.self-registrations.update", [$selfRegistration->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_detail') ? 'is-invalid' : '' }}" type="text" name="id_detail" id="id_detail" value="{{ old('id_detail', $selfRegistration->id_detail) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $selfRegistration->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $selfRegistration->state) }}">
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('visiting_office') ? 'is-invalid' : '' }}" name="visiting_office_id" id="visiting_office_id" required>
                    @foreach($visiting_offices as $id => $entry)
                        <option value="{{ $id }}" {{ (old('visiting_office_id') ? old('visiting_office_id') : $selfRegistration->visiting_office->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $selfRegistration->district) }}">
