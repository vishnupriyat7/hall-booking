...
<div class="card">
    <div class="card-header">
        ...
        GalleryPass {{ trans('cruds.selfRegistration.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route('public.self-registrations.store_gallery') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="dob" id="dob" type="date"  value="{{ old('dob', '') }}"  required/>
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.selfRegistration.fields.group_persons_helper') }}</span>
            </div>
            <input type="hidden" name="pass_type" value="gallery">
