    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.self-registrations.update", [$selfRegistration->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.selfRegistration.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $selfRegistration->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="age" id="age" value="{{ old('age', $selfRegistration->age) }}" step="1" required>
                            @if($errors->has('age'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('age') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $selfRegistration->mobile) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_detail" id="id_detail" value="{{ old('id_detail', $selfRegistration->id_detail) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" id="address">{{ old('address', $selfRegistration->address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $selfRegistration->state) }}">
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('state') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pincode" id="pincode" value="{{ old('pincode', $selfRegistration->pincode) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_visit" id="date_of_visit" value="{{ old('date_of_visit', $selfRegistration->date_of_visit) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="district" id="district" value="{{ old('district', $selfRegistration->district) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_office" id="post_office" value="{{ old('post_office', $selfRegistration->post_office) }}">
