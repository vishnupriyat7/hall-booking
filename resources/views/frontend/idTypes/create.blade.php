    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.id-types.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_length" id="min_length" value="{{ old('min_length', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_length" id="max_length" value="{{ old('max_length', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="regex" id="regex" value="{{ old('regex', '') }}">
                            @if($errors->has('regex'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('regex') }}
                                </div>
