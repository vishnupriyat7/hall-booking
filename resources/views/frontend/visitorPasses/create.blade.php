    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.visitor-passes.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="pass_valid_from" id="pass_valid_from" value="{{ old('pass_valid_from') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="pass_valid_upto" id="pass_valid_upto" value="{{ old('pass_valid_upto') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="issued_date" id="issued_date" value="{{ old('issued_date') }}">
