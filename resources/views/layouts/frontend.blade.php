                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('visitor_pass_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.visitor-passes.index') }}">
                                    ...
                                    @endcan
                                    @can('id_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.id-types.index') }}">
                                            {{ trans('cruds.idType.title') }}
                                        </a>
                                    @endcan
                                    @can('recommending_office_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.recommending-office-categories.index') }}">
                                            {{ trans('cruds.recommendingOfficeCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('recommending_office_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.recommending-offices.index') }}">
                                            {{ trans('cruds.recommendingOffice.title') }}
                                        </a>
                                    @endcan
                                    @can('visiting_office_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.visiting-office-categories.index') }}">
                                            {{ trans('cruds.visitingOfficeCategory.title') }}
                                        </a>
                                    @endcan
                                    @can('visiting_office_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.visiting-offices.index') }}">
                                            {{ trans('cruds.visitingOffice.title') }}
                                        </a>
                                    @endcan
                                    @can('member_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.members.index') }}">
