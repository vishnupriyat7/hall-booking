    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-personVisitorPasses">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <tr data-entry-id="{{ $visitorPass->id }}">
                                ...
                                <td>
                                    @can('visitor_pass_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.visitor-passes.show', $visitorPass->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan

                                    @can('visitor_pass_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('admin.visitor-passes.edit', $visitorPass->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
...
<script>
  ...
  let table = $('.datatable-personVisitorPasses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
