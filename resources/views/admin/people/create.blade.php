    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.people.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recommended_by_detail') ? 'is-invalid' : '' }}" type="text" name="recommended_by_detail" id="recommended_by_detail" value="{{ old('recommended_by_detail', '') }}">
