...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.postOfficeDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.post-office-details.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('epost_delivery_status') ? 'is-invalid' : '' }}" type="text" name="epost_delivery_status" id="epost_delivery_status" value="{{ old('epost_delivery_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_post_flag') ? 'is-invalid' : '' }}" type="text" name="default_post_flag" id="default_post_flag" value="{{ old('default_post_flag', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_office_name') ? 'is-invalid' : '' }}" type="text" name="post_office_name" id="post_office_name" value="{{ old('post_office_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_office_status') ? 'is-invalid' : '' }}" type="text" name="post_office_status" id="post_office_status" value="{{ old('post_office_status', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal_circle') ? 'is-invalid' : '' }}" type="text" name="postal_circle" id="postal_circle" value="{{ old('postal_circle', '') }}">
