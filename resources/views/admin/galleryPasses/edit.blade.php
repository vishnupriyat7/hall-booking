...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.galleryPass.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.gallery-passes.update", [$galleryPass->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="number">{{ trans('cruds.galleryPass.fields.number') }}</label>
                <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="number" name="number" id="number" value="{{ old('number', $galleryPass->number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('person') ? 'is-invalid' : '' }}" name="person_id" id="person_id" required>
                    @foreach($people as $id => $entry)
                        <option value="{{ $id }}" {{ (old('person_id') ? old('person_id') : $galleryPass->person->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('issued_date') ? 'is-invalid' : '' }}" type="text" name="issued_date" id="issued_date" value="{{ old('issued_date', $galleryPass->issued_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_visit') ? 'is-invalid' : '' }}" type="text" name="date_of_visit" id="date_of_visit" value="{{ old('date_of_visit', $galleryPass->date_of_visit) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('guide') ? 'is-invalid' : '' }}" name="guide_id" id="guide_id">
                    @foreach($guides as $id => $entry)
                        <option value="{{ $id }}" {{ (old('guide_id') ? old('guide_id') : $galleryPass->guide->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('guide'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('print_count') ? 'is-invalid' : '' }}" type="number" name="print_count" id="print_count" value="{{ old('print_count', $galleryPass->print_count) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_type') ? 'is-invalid' : '' }}" type="text" name="id_type" id="id_type" value="{{ old('id_type', $galleryPass->id_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_detail') ? 'is-invalid' : '' }}" type="text" name="id_detail" id="id_detail" value="{{ old('id_detail', $galleryPass->id_detail) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $galleryPass->address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $galleryPass->country) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $galleryPass->state) }}">
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $galleryPass->district) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_office') ? 'is-invalid' : '' }}" type="text" name="post_office" id="post_office" value="{{ old('post_office', $galleryPass->post_office) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pincode') ? 'is-invalid' : '' }}" type="text" name="pincode" id="pincode" value="{{ old('pincode', $galleryPass->pincode) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo') ? 'is-invalid' : '' }}" type="text" name="photo" id="photo" value="{{ old('photo', $galleryPass->photo) }}">
                @if($errors->has('photo'))
