...
class VisitingOfficeCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.visitingOfficeCategories.index', compact('visitingOfficeCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.visitingOfficeCategories.create');
    }
    ...
    public function store(StoreVisitingOfficeCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.visiting-office-categories.index');
    }
    ...
    public function edit(VisitingOfficeCategory $visitingOfficeCategory)
    {
        ...
        return view('frontend.visitingOfficeCategories.edit', compact('visitingOfficeCategory'));
    }
    ...
    public function show(VisitingOfficeCategory $visitingOfficeCategory)
    {
        ...
        return view('frontend.visitingOfficeCategories.show', compact('visitingOfficeCategory'));
    }
