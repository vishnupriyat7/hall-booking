...
class VisitingOfficeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.visitingOffices.index', compact('visitingOffices'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.visitingOffices.create', compact('categories'));
    }
    ...
    public function store(StoreVisitingOfficeRequest $request)
    {
        ...
        return redirect()->route('admin.visiting-offices.index');
    }
    ...
    public function edit(VisitingOffice $visitingOffice)
    {
        ...
        return view('admin.visitingOffices.edit', compact('categories', 'visitingOffice'));
    }
    ...
    public function show(VisitingOffice $visitingOffice)
    {
        ...
        return view('admin.visitingOffices.show', compact('visitingOffice'));
    }
